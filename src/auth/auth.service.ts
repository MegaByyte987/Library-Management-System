...
export class AuthService {
    ...
    private readonly membersService: MembersService, private readonly booksService: BooksService, private readonly transactionsService: TransactionsService, private readonly jwtService: JwtService,)
    {}
    ...
    async registerTransaction(registerTransactionDto: RegisterTransactionDto){
        const transaction = await this.transactionsService.create(registerTransactionDto);
